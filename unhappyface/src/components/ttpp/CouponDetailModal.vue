    ...
    <div class="modal-overlay">
      <div class="modal-content">
        ...
        <span class="notice-type-badge">
          {{ itemTypeText(coupon.itemType) }}
        </span>
        <p class="modal-content-text">{{ coupon.content }}</p>
        <div class="created-at">優惠券開始時間：{{ formatDate(coupon.startAt) }}</div>
        <div v-if="coupon.isRead" class="read-status read">已讀</div>
